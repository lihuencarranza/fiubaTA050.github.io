...
<table class="calendario">
  ...
  <tbody>
    <tr>
      ...
      <td class="calendar-activity"><span class="lecture-title">Clase 1 — Introducción y RPC</span>
        <dl class="cal-activity-dl">
          ...
          <dd class="cal-mobile-only"><a href="https://drive.google.com/file/d/1nvDap74mlYvCX81Cc1maEGsZ_fKwhrgu/view?usp=drive_link" class="schedule-badge">Descargar <i class="fas fa-arrow-circle-down"></i></a></dd>
    ...
    <tr class="cal-feriado">
      <td>3 abr</td>
      <td class="calendar-activity"><span class="lecture-title">FERIADO</span></td>
      <td>—</td>
      <td>—</td>
    </tr>
    <tr>
